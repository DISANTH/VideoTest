...
/** @brief 
 *      This API Function used to geting the sim physical number. 
 *    @param  buf 
 *     Description: Argument to store the sim physical number
 *          Type: output
 *   @return      
 *        '0' on Success.
 *       '-1' on Error.
 */
int gl11_gsm_simnum( char *buf );
...
/** @brief 
 *      This API Function used to disable or enable the internal camera flash .
 *  @param state
 *      Description: Depends on input state API should be enable or disable the internal camera flash;
 *      Type: input ;
 *      Range: 0 for disable the internal camera flash;
 *             1 for enable the internal camera flash .
 *  @return      
 *      '0' on Success;
 *     '-1' on fail;
 *     '-2' on Argument error;
